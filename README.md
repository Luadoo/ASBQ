...
* epoch: 240; (It is an option, for example: 32-bit -> 8-bit, only using 80 epochs. Our paper used the maximum for CIFAR.)
* Batch size: 128;
...
* epoch: for 32-bit,1-bit is 100 epochs; (It is an option, for example: 32-bit -> 8-bit, only using 60 epochs.)
* Batch size: 256;
