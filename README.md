...
* Our ASBQ outperforms recent work SKD-BNN methods; we push the limit of QAT in BNN using knowledge transfer, with reality outperformance. The SKD-BNN code resource report states that the training is bad, and testing is good. (https://github.com/Wzixin/SKD-BNN/blob/main/ImageNet/record_log/resnet18-2.log)
